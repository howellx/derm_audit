...
def save_fid_score(fid_score, checkpoint_path, n_samples, csv_path='fid_scores.csv'):
    """Save FID score and metadata to CSV"""
    data = {
...
def evaluate_model(ddpm, dataset, checkpoint_path, n_samples=1000, image_size=256, csv_path='fid_scores.csv'):
...
if __name__ == "__main__":
    ...
    print(f"Score saved to fid_scores.csv")
